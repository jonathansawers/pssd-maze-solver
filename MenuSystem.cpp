...
void MenuSystem::displayMainMenu() const {
  ...
  std::cout << "1. " << Colors::GREEN << "Generate Maze" << Colors::RESET
            << std::endl;
  std::cout << "2. " << Colors::BLUE << "Solve Maze" << Colors::RESET
            << std::endl;
  std::cout << "3. " << Colors::YELLOW << "Display Maze" << Colors::RESET
            << std::endl;
  std::cout << "4. " << Colors::MAGENTA << "Set Start/End Positions"
            << Colors::RESET << std::endl;
  std::cout << "5. " << Colors::CYAN << "Show Maze Info" << Colors::RESET
            << std::endl;
...
void MenuSystem::displayGenerationMenu() const {
  ...
  std::cout << "1. " << Colors::GREEN << "DFS (Depth-First Search)"
            << Colors::RESET << " - Recursive backtracking" << std::endl;
  std::cout << "2. " << Colors::BLUE << "Prim's Algorithm" << Colors::RESET
            << " - Randomized minimum spanning tree" << std::endl;
  std::cout << "3. " << Colors::YELLOW << "Back to Main Menu" << Colors::RESET
            << std::endl;
  std::cout << std::endl;
}
...
void MenuSystem::displaySolverMenu() const {
  std::cout << Colors::BRIGHT_CYAN << "=== MAZE SOLVING ===" << Colors::RESET
            << std::endl;
  std::cout << "1. " << Colors::GREEN << "DFS (Depth-First Search)"
            << Colors::RESET << " - Recursive exploration" << std::endl;
  std::cout << "2. " << Colors::BLUE << "BFS (Breadth-First Search)"
            << Colors::RESET << " - Level-by-level exploration" << std::endl;
  std::cout << "3. " << Colors::MAGENTA << "A* (A-Star)" << Colors::RESET
            << " - Heuristic-based search" << std::endl;
...
void MenuSystem::generateMaze() {
  ...
  std::cout << Colors::YELLOW << "Generating maze..." << Colors::RESET
            << std::endl;
  ...
  std::cout << "  Start: (" << currentMaze->getStart().first << ", "
            << currentMaze->getStart().second << ")" << std::endl;
  std::cout << "  End: (" << currentMaze->getEnd().first << ", "
...
void MenuSystem::setStartEndPositions() {
  ...
  std::cout << "Current start: (" << currentMaze->getStart().first << ", "
            << currentMaze->getStart().second << ")" << std::endl;
  std::cout << "Current end: (" << currentMaze->getEnd().first << ", "
            << currentMaze->getEnd().second << ")" << std::endl;
  std::cout << std::endl;
  ...
  std::cout << Colors::GREEN << "Start and end positions updated!"
            << Colors::RESET << std::endl;
...
void MenuSystem::showMazeInfo() {
  ...
  if (!currentMaze) {
    ...
    std::cout << "Start Position: (" << currentMaze->getStart().first << ", "
              << currentMaze->getStart().second << ")" << std::endl;
    std::cout << "End Position: (" << currentMaze->getEnd().first << ", "
              << currentMaze->getEnd().second << ")" << std::endl;
    std::cout << "Total Cells: "
              << currentMaze->getWidth() * currentMaze->getHeight()
              << std::endl;
  }
